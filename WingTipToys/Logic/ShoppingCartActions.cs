...
namespace WingtipToys.Logic
{
    public class ShoppingCartActions : IDisposable
    {
        ...
        public void AddToCart(int id)
        {
            ...
            //If the item isn't in the cart, add to the cart
            if (cartItem == null)
            {
        ...
        //Queries all the items in the current cart via CartId and it must be equal to the current session ShoppingCartId
        public decimal GetCartTotal()
        {
            ShoppingCartId = GetCartId();
            decimal? total = decimal.Zero;
            total = (decimal?) (from cartItems in _db.ShoppingCartItems where cartItems.CartId == ShoppingCartId
